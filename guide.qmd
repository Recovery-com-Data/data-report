...
!["forest"](assets/guide/forest.png){width="45%"}

!["ocean"](assets/guide/ocean.png){width="45%"}

!["sunset"](assets/guide/sunset.png){width="45%"}

!["monochrome"](assets/guide/monochrome.png){width="45%"}
:::

This template supports four different color themes, based on Recovery.com branding. These were designed to allow us to have variance in the look of our report, while keeping a professional look. More themes could be added easily as well.

For example, set the `report-theme` parameter to "forest" to use the forest green theme.
...
The template has some document parameters to make it easier to keep track of different versions of reports
...
![](assets/guide/watermark.png){width="30%"}
...
2.  **Document Structure**
    ...
    ├── guide.pdf               # PDF version of guide
    ├── guide.qmd               # Quarto version to show code
